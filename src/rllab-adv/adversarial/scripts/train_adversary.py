...
save_prefix = 'RARL-env-{}_Exp{}_Itr{}_BS{}_Adv{}_stp{}_lam{}{}_{}'.format(env_name, n_exps, n_itr, batch_size, adv_fraction, step_size, gae_lambda, noise_str, random.randint(0,1000000))
