...
class InvertedDoublePendulumEnv(mujoco_env.MujocoEnv, utils.EzPickle):
    ...
    def reset_model(self):
        self.set_state(
            self.init_qpos + self.np_random.uniform(low=-self.reset_noise_scale, high=self.reset_noise_scale, size=self.model.nq),
            self.init_qvel + self.np_random.randn(self.model.nv) * self.reset_noise_scale
        )
